...
function onCreatePost()
	makeLuaText("nigger", "TRANNY OUTRAGE :", 600, 760, 20)
	addLuaText("nigger")
	setTextSize("nigger", 25)
	setTextAlignment("nigger", 'left')
	makeLuaText("art", "ART BY SKUMZ AND TOADR", 600, 1020, 10)
	addLuaText("art")
	setTextSize("art", 15)
	setTextAlignment("art", 'left')
	makeLuaText("song", "SONG BY SEAL", 600, 1020, 25)
	addLuaText("song")
	setTextSize("song", 15)

...
function onCreatePost()
	makeLuaText("nigger", "GOOD ENDING :", 600, 760, 20)
	addLuaText("nigger")
	setTextSize("nigger", 25)
	setTextAlignment("nigger", 'left')
	makeLuaText("art", "ART BY SKUMZ", 600, 970, 10)
	addLuaText("art")
	setTextSize("art", 15)
	setTextAlignment("art", 'left')
	makeLuaText("song", "SONG BY SKUMZ", 600, 970, 25)
	addLuaText("song")
	setTextSize("song", 15)
	setTextAlignment("song", 'left')
	makeLuaText("chart", "CHART BY TOADSTOLS", 600, 970, 40)
	addLuaText("chart")
